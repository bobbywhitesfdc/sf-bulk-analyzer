...
* [Commands](#commands)
* [Customizing Error Classifiers](#customizing-error-classifiers)
<!-- tocstop -->
...
<!-- commands -->
* [`sf bulk analyze JOBID`](#sf-bulk-analyze-jobid)
* [`sf bulk analyze-files DIR`](#sf-bulk-analyze-files-dir)
* [`sf bulk install-skill`](#sf-bulk-install-skill)
* [`sf bulk list-jobs`](#sf-bulk-list-jobs)
<!-- commandsstop -->
